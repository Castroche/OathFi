...
class RiskCheck(Base, TimestampMixin):
    ...
    reward_risk = Column(Float, default=0.0, nullable=False)
    rule_results_json = Column(JSON, default=list, nullable=False)
    market_data_status = Column(String, default="live", nullable=False)

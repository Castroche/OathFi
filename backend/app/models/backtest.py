...
class BacktestResult(Base, TimestampMixin):
    ...
    drawdown_curve_json = Column(JSON, default=list, nullable=False)
    trade_distribution_json = Column(JSON, default=list, nullable=False)
    verdict_json = Column(JSON, default=dict, nullable=False)
    strategy_rule_json = Column(JSON, default=dict, nullable=False)
